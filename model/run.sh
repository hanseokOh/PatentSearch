...
### Merge train set 
#######
DATA_PATH1="../data/summary_origin"
...
PATH_TO_OUTPUT_DIR=./checkpoint/final.finetuned.contriever
...
CUDA_VISIBLE_DEVICES='1,2,3' python -m torch.distributed.launch --nproc_per_node=3 finetuning.py \
        ...
        --pooling average \
        --train_data $PATH_TO_TRAIN_DATA_2 \
        ...
        --negative_ctxs=5 \
        --eval_datasets 'generated_summary_ver' 'summary_origin' \
